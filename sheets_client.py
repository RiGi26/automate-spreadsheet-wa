...
SHEET_HEADERS = {
    ...
    'BLAST_QUEUE':  ['STATUS', 'PESAN', 'TIMESTAMP', 'TARGET'],
}

DEFAULT_TERAPIS = [
    ['A', '09:00', 2, 'senior'], ['A', '10:00', 2, 'senior'],
    ['A', '10:30', 2, 'senior'], ['A', '11:00', 2, 'senior'],
    ['A', '14:00', 2, 'senior'], ['A', '14:30', 2, 'senior'],
    ['A', '15:00', 2, 'senior'],
    ['B', '08:00', 2, 'senior'], ['B', '08:30', 2, 'senior'],
    ['B', '09:00', 2, 'senior'], ['B', '10:00', 2, 'senior'],
    ['B', '10:30', 2, 'senior'], ['B', '11:00', 2, 'senior'],
    ['B', '14:00', 2, 'senior'], ['B', '14:30', 2, 'senior'],
    ['B', '15:00', 2, 'senior'],
    ['C', '08:00', 3, 'senior'], ['C', '08:30', 3, 'senior'],
    ['C', '09:00', 3, 'senior'], ['C', '10:00', 3, 'senior'],
    ['C', '10:30', 3, 'senior'], ['C', '11:00', 3, 'senior'],
    ['C', '14:00', 3, 'senior'], ['C', '14:30', 3, 'senior'],
    ['C', '15:00', 3, 'senior'],
    ['D', '08:00', 1, 'bantu'], ['D', '08:30', 1, 'bantu'],
]
...
class SheetsClient:
    ...
    def setup_all_sheets(self):
        for name, header in SHEET_HEADERS.items():
            ...
            if name == 'TERAPIS' and len(ws.get_all_records()) == 0:
                ...
                log.info("Sheet TERAPIS diisi data default")
        log.info("Semua sheet siap")

    def _get_or_create_worksheet(self, name, header):
        try:
    ...
    def append_rows(self, rows):
        ...
        try:
            ...
            self._init_client()
            self.get_worksheet('Jadwal').append_rows(data, value_input_option='USER_ENTERED')
            return len(data)
        except Exception as e:
